...
#define RTFS_RTEMS_ITEST_RAMDISK_DEVICE_PATH "/dev/rtfs-ram0"
...
#define RTFS_RTEMS_ITEST_DEVICE_MODE_ENV "RTFS_ITEST_DEVICE_MODE"
#define RTFS_RTEMS_ITEST_DEVICE_PATH_ENV "RTFS_ITEST_DEVICE_PATH"
